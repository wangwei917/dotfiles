...
map <F3> :s/^/#<CR>:noh<CR>:echo<CR>
map <F4> :s/^#/<CR>:noh<CR>:echo<CR>
set pastetoggle=<F2>
...
nmap <Leader>c= :Tab /=<CR>
vmap <Leader>c= :Tab /=<CR>
nmap <Leader>c: :Tab /:\zs<CR>
vmap <Leader>c: :Tab /:\zs<CR>
        
set lines=47 columns=175
set backup 
